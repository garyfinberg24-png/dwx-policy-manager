...
export interface IDwxPolicyAuthorViewWebPartProps {
  title: string;
}

export default class DwxPolicyAuthorViewWebPart extends BaseClientSideWebPart<IDwxPolicyAuthorViewWebPartProps> {
