...
export interface IDwxPolicyManagerViewWebPartProps {
  title: string;
}

export default class DwxPolicyManagerViewWebPart extends BaseClientSideWebPart<IDwxPolicyManagerViewWebPartProps> {
