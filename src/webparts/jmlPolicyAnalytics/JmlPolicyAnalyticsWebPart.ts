...
export interface IJmlPolicyAnalyticsWebPartProps {
  title: string;
}

export default class JmlPolicyAnalyticsWebPart extends BaseClientSideWebPart<IJmlPolicyAnalyticsWebPartProps> {
